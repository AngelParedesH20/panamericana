...
DATABASE_URL=postgresql://postgres.tvyhpwpyxmbdfxogopnl:VikgYYOHWRYIsQy2@aws-0-us-east-1.pooler.supabase.com:5432/postgres
...
> La `DATABASE_URL` ya trae la contraseña de la base: **no compartas este archivo fuera del equipo**.
